...
| **Architecture** | [`docs/architecture/`](./architecture/) | System design, deep module analysis, refactoring candidates & visual flows | [Architecture Index](./architecture/README.md) · [System Overview](./architecture/system-overview.md) · [Technical Breakdown](./architecture/technical-architecture-breakdown.md) · [High-Level & Intuition](./architecture/high-level-architecture-and-intuition.md) · [Flow Walkthrough](./architecture/in-depth-flow-walkthrough.md) · [Architecture Explained](./architecture/architecture-explained.md) · [Visual Flows](./architecture/architecture-visual-flows.md) · [Beginner Guide](./architecture/beginner-guide.html) · [Interactive Review](./architecture/architecture-review.html) |
